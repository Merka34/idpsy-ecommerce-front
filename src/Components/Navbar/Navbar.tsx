...
const Navbar = () => {
    ...
    <nav className="navbar bg-white shadow-md lg:shadow-sm w-full min-h-[70px] px-4 md:px-6">
        ...
        {/* Logo - Izquierda (Mobile: ocupa espacio, Desktop: ancho fijo) */}
        <div className="navbar-start w-auto md:w-1/4 lg:w-1/5">
            ...
            <div className="dropdown md:hidden">
                ...
                <ul tabIndex={0} className="dropdown-content menu menu-sm bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
                    {/* Puedes agregar elementos del menú aquí si es necesario */}
                </ul>
            </div>
        </div>

        {/* Barra de búsqueda - Centro (Mobile: oculto, Desktop: visible) */}
        <div className="navbar-center hidden md:flex md:w-2/4 lg:w-3/5 px-4">
                ...
                <div className="relative">
                    ...
                    <button type="button" onClick={doSearch} className="absolute right-3 top-1/2 transform -translate-y-1/2 bg-primary text-white p-2 rounded-full hover:bg-primary/90 transition-colors">
        ...
        {/* Iconos y botones - Derecha */}
        <div className="navbar-end w-auto md:w-1/4 lg:w-1/5 gap-2 md:gap-4">
            {/* Barra de búsqueda para móvil (icono) */}
            ...
            {userInfo?.isAdmin && (
                <Link
                    ...
                    className="hidden md:inline-flex btn btn-primary btn-sm lg:btn-md"
                >
            ...
            {/* Para móvil: mostrar icono de usuario si está autenticado */}
    ...
    <div className="md:hidden bg-white border-t px-4 py-3">
        <div className="relative">
            <input 
                type="text" 
                placeholder="Buscar productos..." 
                className="w-full pl-10 pr-4 py-2 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
            />
